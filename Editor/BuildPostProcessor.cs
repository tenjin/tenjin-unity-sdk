...
public class BuildPostProcessor : MonoBehaviour
{
    ...
    private static List<string> GetTenjinAssets()
    {
        ...
        tenjinAssets.Add(assetsPath + "/Plugins/iOS/unity-plugin-library.a");
    ...
    // Maps Unity project asset paths to UPM package paths
    private static readonly Dictionary<string, string> UpmPathMap = new Dictionary<string, string>
    {
        // Editor files
        { "Assets/Editor/BuildPostProcessor.cs", "Editor/BuildPostProcessor.cs" },
        { "Assets/Editor/Dependencies.xml", "Editor/Dependencies.xml" },
        { "Assets/Tenjin/Scripts/Editor/TenjinAssetSelector.cs", "Editor/TenjinAssetSelector.cs" },
        { "Assets/Tenjin/Scripts/Editor/TenjinEditorPrefs.cs", "Editor/TenjinEditorPrefs.cs" },
        { "Assets/Tenjin/Scripts/Editor/TenjinPackager.cs", "Editor/TenjinPackager.cs" },
        // Plugins
        { "Assets/Plugins/Android/GradleTemplates/m2repository.gradle", "Plugins/Android/GradleTemplates/m2repository.gradle" },
        { "Assets/Plugins/iOS/TenjinSDK.h", "Plugins/iOS/TenjinSDK.h" },
        { "Assets/Plugins/iOS/TenjinSDK.xcframework.zip", "Plugins/iOS/TenjinSDK.xcframework.zip" },
        { "Assets/Plugins/iOS/TenjinUnityInterface.h", "Plugins/iOS/TenjinUnityInterface.h" },
        { "Assets/Plugins/iOS/TenjinUnityInterface.mm", "Plugins/iOS/TenjinUnityInterface.mm" },
        { "Assets/Plugins/iOS/unity-plugin-library.a", "Plugins/iOS/unity-plugin-library.a" },
        // Runtime scripts
        { "Assets/Tenjin/Scripts/AndroidTenjin.cs", "Runtime/AndroidTenjin.cs" },
        { "Assets/Tenjin/Scripts/AppStoreType.cs", "Runtime/AppStoreType.cs" },
        { "Assets/Tenjin/Scripts/BaseTenjin.cs", "Runtime/BaseTenjin.cs" },
        { "Assets/Tenjin/Scripts/CspManager.cs", "Runtime/CspManager.cs" },
        { "Assets/Tenjin/Scripts/DebugTenjin.cs", "Runtime/DebugTenjin.cs" },
        { "Assets/Tenjin/Scripts/iOSTenjin.cs", "Runtime/iOSTenjin.cs" },
        { "Assets/Tenjin/Scripts/Tenjin.cs", "Runtime/Tenjin.cs" },
        { "Assets/Tenjin/Scripts/TenjinAdMobIntegration.cs", "Runtime/TenjinAdMobIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinAppLovinIntegration.cs", "Runtime/TenjinAppLovinIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinCASIntegration.cs", "Runtime/TenjinCASIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinHyperBidIntegration.cs", "Runtime/TenjinHyperBidIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinIronSourceIntegration.cs", "Runtime/TenjinIronSourceIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinTopOnIntegration.cs", "Runtime/TenjinTopOnIntegration.cs" },
        { "Assets/Tenjin/Scripts/TenjinTradPlusIntegration.cs", "Runtime/TenjinTradPlusIntegration.cs" },
    };
    ...
    public static void ExportTenjinUpmPackage()
    {
        ...
        foreach (var mapping in UpmPathMap)
        {
            string srcPath = mapping.Key;
            string dstPath = Path.Combine(upmOutputPath, mapping.Value);
            ...
            if (File.Exists(fullSrcPath))
            {
                ...
                Debug.Log($"TenjinSDK UPM: Copied {srcPath} -> {mapping.Value}");
            }
            else
            {
        ...
        Debug.Log($"TenjinSDK UPM: Export complete -> {upmOutputPath}");
    }
