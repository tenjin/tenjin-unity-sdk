...
- [SDK Integration][5]
  ...
  - [Impression Level Ad Revenue Integration][27]
	...
	- [AdMob Impression Level Ad Revenue Integration][31]
- [Testing][32]
...
> *NOTE*, Please ensure you have the latest HyperBid Unity SDK installed (\> HyperBid\_Unity\_Release\_Android&iOS\_5.7.79)
...
1. Install the HyperBid Unity SDK: [https://docs.hyperbid.com/#/en-us/unity/download/package?id=hyperbid-unity-sdk-integration-tool][72]
...
| Parameter  | Example |
| ------------- | ------------- |
| hyperbid[adsource\_index] | 0 |
| hyperbid[ad\_network\_type] | String |
| hyperbid[is\_header\_bidding\_adsource] | Int |
| hyperbid[ecpm\_precision] | String |
| hyperbid[adsource\_id] | 5656 |
| hyperbid[ecpm] | 1 |
| hyperbid[scenario\_id] | String |
| hyperbid[custom\_rule] | String |
| hyperbid[sub\_channel] | testSubChannel |
| hyperbid[publisher\_revenue\_micro] | 1000 |
| hyperbid[publisher\_revenue] | 0.001 |
| hyperbid[scenario\_reward\_name] | String |
| hyperbid[channel] | testChannel |
| hyperbid[hyper\_bid\_ad\_format] | String |
| hyperbid[segment\_id] | 0 |
| hyperbid[country] | DE |
| hyperbid[show\_id] | String |
| hyperbid[scenario\_reward\_number] | 0 |
| hyperbid[network\_placement\_id] | ca-app-pub-3940256099942544%2F6300978111 |
| hyperbid[hyper\_bid\_placement\_id] | String |
| hyperbid[ecpm\_level] | 1 |
| hyperbid[reward\_user\_custom\_data] | String |
| hyperbid[network\_firm\_id] | 2 |
| hyperbid[currency] | USD |
| hyperbid[publisher\_revenue\_decimal] | 0.001 |
| hyperbid[precision] | String |

## <a id="admob"></a>AdMob Impression Level Ad Revenue Integration
> *NOTE*, Please ensure you have the latest AdMob Unity SDK installed (\> GoogleMobileAds-v7.0.0)

The Tenjin SDK can listen to AdMob ILRD ad impressions and send revenue events to Tenjin.  This integration will send revenue related for each ad impression served from AdMob.  Here are the steps to integrate:

1. Install the AdMob Unity SDK: [https://developers.google.com/admob/unity/quick-start#download\_the\_mobile\_ads\_unity\_plugin][73]
2. When initializing the Tenjin SDK, subscribe to AdMob Impressions:

```csharp
var tenjin = Tenjin.getInstance("<API_KEY>");
tenjin.Connect();
tenjin.SubscribeAdMobBannerViewImpressions(this.bannerView, "<YOUR-AD-UNIT-ID>");
tenjin.SubscribeAdMobRewardedAdImpressions(this.rewardedAd, "<YOUR-AD-UNIT-ID>");
tenjin.SubscribeAdMobInterstitialAdImpressions(this.interstitialAd, "<YOUR-AD-UNIT-ID>");
tenjin.SubscribeAdMobRewardedInterstitialAdImpressions(this.rewardedInterstitialAd, "<YOUR-AD-UNIT-ID>");
```

Below is an example of AdMob Banner integration and subscribing to impression events.

```csharp
public class AdMobBehavior : MonoBehaviour
{
    ...
    private void InitializeAdMob()
    {
        ...
        this.bannerView = new BannerView("<YOUR-AD-UNIT-ID>", AdSize.Banner, AdPosition.Top);
        ...
        this.bannerView.OnPaidEvent += (sender, args) =>
        {
            ...
            Debug.Log($"ad value (in micros): {adValue.Value}, precision: {adValue.Precision}, currency: {adValue.CurrencyCode}");
        };
        // subscribe to admob impression
        t.SubscribeAdMobBannerViewImpressions(this.bannerView, "<YOUR-AD-UNIT-ID>");
    }
...
| Parameter  | Example |
| ------------- | ------------- |
| admob[publisher\_revenue\_micro] | 0 |
| admob[ad\_unit\_id] | ca-app-pub-3940256099942544%2F2934735716 |
| admob[publisher\_revenue\_decimal] | 0 |
| admob[currency\_code] | USD |
| admob[response\_id] | CKak5t\_oovcCFRPJdwodJXQNRw |
| admob[value\_micros] | 0 |
| admob[mediation\_adapter\_class\_name] | GADMAdapterGoogleAdMobAds |
| admob[precision\_type] | Unknown |
